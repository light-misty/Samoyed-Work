...
static CONTEXT_PRESETS: &[ContextPreset] = &[
    ...
    ContextPreset {
        model_pattern: "qwen3.6-plus",
        context_window: 1_000_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "qwen3.6-max",
        context_window: 1_000_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "qwen3-235b",
        context_window: 262_144,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "qwen3-30b",
        context_window: 262_144,
        provider_type: None,
    },
    ContextPreset {
    ...
    ContextPreset {
        model_pattern: "moonshot-v1-128k",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "moonshot-v1-32k",
    ...
    // 百度 ERNIE
    ContextPreset {
        model_pattern: "ernie-5.1",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "ernie-4.0",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "ernie-3.5",
        context_window: 32_000,
        provider_type: None,
    },
    ContextPreset {
    ...
    // 字节跳动 Doubao/Seed
    ContextPreset {
        model_pattern: "seed-2.0-pro",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "doubao-1.5-pro",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "doubao-1.5-lite",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "doubao",
        context_window: 128_000,
        provider_type: None,
    },
    // MiniMax
    ContextPreset {
        model_pattern: "minimax-m2.7",
        context_window: 200_000,
        provider_type: None,
    },
    ContextPreset {
    ...
    // 零一万物 Yi
    ContextPreset {
        model_pattern: "yi-large",
        context_window: 200_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "yi-lightning",
    ...
    // Mistral
    ContextPreset {
        model_pattern: "mistral-large-3",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "mistral-small-4",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
        model_pattern: "magistral",
        context_window: 128_000,
        provider_type: None,
    },
    ContextPreset {
...
pub fn resolve_context_window(model_name: &str, provider_type: Option<&str>) -> usize {
    ...
    let skip_openai_presets =
        provider_type == Some("openai") && !is_openai_official_model(model_name);
...
mod tests {
    ...
    fn test_openai_gpt41_mini() {
        assert_eq!(
            resolve_context_window("gpt-4.1-mini", Some("openai")),
            1_000_000
        );
    }
    ...
    fn test_openai_gpt35_turbo() {
        assert_eq!(
            resolve_context_window("gpt-3.5-turbo", Some("openai")),
            16_385
        );
    }
    ...
    fn test_anthropic_claude_3_5_sonnet() {
        assert_eq!(
            resolve_context_window("claude-3-5-sonnet-20241022", Some("anthropic")),
            200_000
        );
    }
    ...
    fn test_anthropic_claude_opus_4_7() {
        assert_eq!(
            resolve_context_window("claude-opus-4-7-20260501", Some("anthropic")),
            2_000_000
        );
    }
    ...
    fn test_anthropic_claude_fallback() {
        ...
        assert_eq!(
            resolve_context_window("claude-some-new-model", Some("anthropic")),
            200_000
        );
    }
    ...
    fn test_gemini_2_5_pro() {
        assert_eq!(
            resolve_context_window("gemini-2.5-pro", Some("gemini")),
            1_000_000
        );
    }
    ...
    fn test_gemini_1_5_pro() {
        assert_eq!(
            resolve_context_window("gemini-1.5-pro", Some("gemini")),
            2_000_000
        );
    }
    ...
    fn test_openai_compatible_deepseek() {
        ...
        assert_eq!(
            resolve_context_window("deepseek-v3", Some("openai")),
            128_000
        );
        assert_eq!(
            resolve_context_window("deepseek-r1", Some("openai")),
            128_000
        );
    }
    ...
    fn test_openai_compatible_qwen() {
        ...
        assert_eq!(
            resolve_context_window("qwen-max", Some("openai")),
            1_000_000
        );
    }
    ...
    fn test_custom_provider_deepseek() {
        ...
        assert_eq!(
            resolve_context_window("deepseek-v3", Some("custom")),
            128_000
        );
        assert_eq!(
            resolve_context_window("deepseek-r2", Some("custom")),
            1_000_000
        );
    }
    ...
    fn test_custom_provider_llama() {
        assert_eq!(
            resolve_context_window("llama-4-scout", Some("custom")),
            10_000_000
        );
        assert_eq!(
            resolve_context_window("llama-3.1-70b", Some("custom")),
            128_000
        );
    }
    ...
    fn test_unknown_model_fallback() {
        assert_eq!(
            resolve_context_window("some-unknown-model", None),
            DEFAULT_CONTEXT_WINDOW
        );
        assert_eq!(
            resolve_context_window("unknown", Some("custom")),
            DEFAULT_CONTEXT_WINDOW
        );
    }
    ...
    fn test_case_insensitive() {
        assert_eq!(resolve_context_window("GPT-4O", Some("openai")), 128_000);
        assert_eq!(
            resolve_context_window("Claude-3-5-Sonnet", Some("anthropic")),
            200_000
        );
        assert_eq!(
            resolve_context_window("DeepSeek-V3", Some("custom")),
    ...
    fn test_model_name_with_version_suffix() {
        // 模型名可能带版本后缀，如日期
        assert_eq!(
            resolve_context_window("gpt-4o-2024-05-13", Some("openai")),
            128_000
        );
        assert_eq!(
            resolve_context_window("claude-3-5-sonnet-20241022", Some("anthropic")),
    ...
    fn test_kimi_models() {
        ...
        assert_eq!(
            resolve_context_window("moonshot-v1-128k", Some("custom")),
            128_000
        );
    }
    ...
    fn test_doubao_models() {
        assert_eq!(
            resolve_context_window("doubao-1.5-pro", Some("custom")),
            128_000
        );
        assert_eq!(
            resolve_context_window("seed-2.0-pro", Some("custom")),
            128_000
        );
    }
    ...
    fn test_mistral_models() {
        assert_eq!(
            resolve_context_window("mistral-large-3", Some("custom")),
            128_000
        );

export const BUILTIN_SUPERPOWERS_CONTENT = `# Superpowers - AI Programming Skills Framework
...
export const BUILTIN_SUPERPOWERS_NAME = "superpowers";
export const BUILTIN_SUPERPOWERS_DESCRIPTION = "Built-in TDD + Systematic debugging workflow framework";

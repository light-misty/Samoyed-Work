...
> 现有 `AgentContext`(见 [context.rs:186](file:///d:/DeskTop/Samoyed-Work/src-tauri/src/services/agent/context.rs#L186))没有 `db` 字段,本任务需要添加。
...
use samoyed_work_lib::services::skill::{SkillLoader, SkillRegistry, SkillTool};
use samoyed_work_lib::services::tool::trait_def::Tool;
use samoyed_work_lib::services::code::parser::{LanguageParser, ProgrammingLanguage};
use samoyed_work_lib::services::code::search::{SourceCodeSearcher, SearchQuery};
use samoyed_work_lib::models::todo::{TodoList, TodoItem, TodoStatus, TodoPriority};
use serde_json::json;
use std::path::PathBuf;

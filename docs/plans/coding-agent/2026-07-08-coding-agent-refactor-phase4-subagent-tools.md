...
impl WebFetcher {
    pub fn new() -> Self {
        let client = Client::builder()
            ...
            .user_agent("Mozilla/5.0 (compatible; Samoyed-Work/1.0)")
            .build()
...
use samoyed_work_lib::services::agent::sub_executor::SubAgentExecutor;
use samoyed_work_lib::services::tool::builtin::{WebFetchTool, WebSearchTool};
use samoyed_work_lib::services::tool::trait_def::Tool;
use samoyed_work_lib::services::web::{UrlValidator, ValidationResult};
use samoyed_work_lib::models::sub_agent::{SubAgentConfig, SubAgentStatus};
use serde_json::json;
...
async fn test_websearch_tool_parameters() {
    let config = samoyed_work_lib::config::app_settings::WebSearchConfig::default();
